      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="flex gap-3 pt-2 sm:pt-4">
            <a
              href="#"
              className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center bg-gray-500 hover:bg-gray-600 transition"
            >
              <Phone className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
            </a>
            <a
              href="#"
              className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center bg-[#25D366] hover:bg-[#20b858] transition"
            >
              <svg
